...
class NewMatchPlayersValidatorTest extends TestCase
{
    ...
    public function testCheckNameSymbolsError1(): void
    {
        ...
        $this->assertEquals("Name must contains only letters one space between words if there are two words and must contain one '-' symbol", $errors['player1']['symbolsName']);
    }
    ...
    public function testValidateExcption()
    {
